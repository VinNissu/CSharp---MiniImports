...
namespace mini_imports
{
    public partial class cadfun : Form
    {
        ...
        private void cadfun_Load(object sender, EventArgs e)
        {
            ...
            textBox1.MaxLength = 15;  // FONE 
            textBox2.MaxLength = 50;  // NOME
            textBox3.MaxLength = 15;  // RG
            textBox4.MaxLength = 15;  // CPF
            textBox5.MaxLength = 50;  // ENDEREÇO
            textBox6.MaxLength = 50;  // EMAIL
            textBox7.MaxLength = 50;  // CARGO
            textBox8.MaxLength = 50;  // LOGIN
            textBox9.MaxLength = 50;  // SENHA
        }
